...
class OrderCommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderComment
        fields = ['id', 'author_username', 'text', 'created']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = [
            'id', 'status', 'status_display', 'delivery_method', 'full_name', 'email', 'phone',
            'address', 'items', 'comments', 'total_price', 'created', 'updated',
        ]
...
class ManagerOrderSerializer(OrderSerializer):
    ...
    class Meta(OrderSerializer.Meta):
        fields = OrderSerializer.Meta.fields + ['username', 'user']
