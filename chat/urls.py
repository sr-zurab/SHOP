...
from .api_views import (
    ChatMessageListView, ChatUnreadCountView, ManagerUnreadCountView,
    ManagerChatRoomListView, AssignChatRoomView, CloseChatRoomView, MarkMessagesReadView,
)
...
urlpatterns = [
    ...
    path('chat/manager/unread-count/', ManagerUnreadCountView.as_view(), name='manager_unread_count'),
